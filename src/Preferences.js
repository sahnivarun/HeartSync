                    ...
                    <ul className="options" style={{ display: "flex", listStyle: "none", padding: 0 }}>
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                checked={target_offspring.includes('Doesn\'t want kids')}
                        ...
                        <li>
                            <input
                                ...
                                id="Want kids"
                                value="Want kids"
                                checked={target_offspring.includes('Want kids')}
                                onChange={(e) => handleOffspringChange(e.target.value)}
                            />
                    ...
                    <ul className="options" style={{ display: "flex", listStyle: "none", padding: 0 }}>
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Likes cats"
                                value="Likes cats"
                                checked={target_pets.includes('Likes cats')}
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Likes dogs"
                                value="Likes dogs"
                                checked={target_pets.includes('Likes dogs')}
                                onChange={(e) => handlePetsChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                checked={target_pets.includes('Likes some other pet')}
                                onChange={(e) => handlePetsChange(e.target.value)}
                            />
                        ...
                        <li>
                            <input
                                ...
                                id="Dislikes pets"
                                value="Dislikes pets"
                                checked={target_pets.includes('Dislikes pets')}
                                onChange={(e) => handlePetsChange(e.target.value)}
                            />
                    ...
                    <ul className="options" style={{ display: "flex", listStyle: "none", padding: 0 }}>
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Often"
                                value="Often"
                                checked={target_smokes.includes('Often')}
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Not at all"
                                value="Not at all"
                                checked={target_smokes.includes('Not at all')}
                                onChange={(e) => handleSmokesChange(e.target.value)}
                            />
                            <label htmlFor="Not at all" style={{ fontSize: "0.9em" }}>Not at all</label>
                        </li>
                        <li>
                            <input
                                ...
                                id="Rarely"
                                value="Rarely"
                                checked={target_smokes.includes('Rarely')}
                                onChange={(e) => handleSmokesChange(e.target.value)}
                            />
                            <label htmlFor="Rarely" style={{ fontSize: "0.9em" }}>Rarely</label>
                        </li>
                    ...
                    <ul className="options" style={{ display: "flex", listStyle: "none", padding: 0 }}>
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Buddhist"
                                value="Buddhist"
                                checked={target_religion.includes('Buddhist')}
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Sikh"
                                value="Sikh"
                                checked={target_religion.includes('Sikh')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Catholic"
                                value="Catholic"
                                checked={target_religion.includes('Catholic')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Christian"
                                value="Christian"
                                checked={target_religion.includes('Christian')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Hindu"
                                value="Hindu"
                                checked={target_religion.includes('Hindu')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Jewish"
                                value="Jewish"
                                checked={target_religion.includes('Jewish')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Muslim"
                                value="Muslim"
                                checked={target_religion.includes('Muslim')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Spiritual"
                                value="Spiritual"
                                checked={target_religion.includes('Spiritual')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li style={{ marginRight: "10px" }}>
                            <input
                                ...
                                id="Agnostic"
                                value="Agnostic"
                                checked={target_religion.includes('Agnostic')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
                        ...
                        <li>
                            <input
                                ...
                                id="Atheist"
                                value="Atheist"
                                checked={target_religion.includes('Atheist')}
                                onChange={(e) => handleReligionChange(e.target.value)}
                            />
